...
discussed. It will also provide an overview on the project and it's objectives to be achieved in the literature 
...
This was the last branch created during development, and focused on getting the app ready for human evaluation. This branch was also when the last requirement, requirement 1.8, was identified and implemented.
...
slightly, though experiences an overall increase when compared from the baseline to week-3. %for 1a, This may be because\dots (expand on this, possibly due to how androids UsageStatsManager queries data) 
