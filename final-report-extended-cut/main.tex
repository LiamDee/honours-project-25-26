...
\begin{titlepage}
   ...
   % \vspace*{0.5 cm}
    ...
    \textsc{\LARGE EXPANDED FINAL REPORT}\\[0.5 cm]	
    \text{2025-26} \\[0.5 cm]	
...
\begin{abstract}
Throughout the rise of social media and smartphones, an ever-growing topic of discussion has been individuals developing an overdependence on such technologies, referred to as ”Social Media 
Addiction” and ”Smartphone Addiction.” Research into the topic discussing the potential causes for it, and possible methods to treat the issue, have been per- formed extensively in the 
past—with the latter looking towards psychological-based treatments such as Cognitive-Based Therapy and Reality Therapy. In recent years, mobile applications that use some form of usage tracking 
have also been looked into to address the issue. Research has shown that psychological-based treatments have produced promising results in treating similar issues such as anxiety; with studies 
showing viability when addressing other mental health concerns. Similarly, studies conducted show viability in utilising usage tracking when addressing the issue, particularly when integrated 
into a mobile app. However, little work has been done to utilise both of these concepts together into a single mobile app.\newline

While psychological-based treatments have shown promising results treating similar mental health conditions, and while research has shown mobile mental health apps could be a viable alternative 
to traditional treatment, little work has been done applying both solutions together to Social Media Addiction and Smartphone Addiction. \newline

This project showcases an Android-based mobile application that integrates concepts from Reality Therapy alongside usage tracking technologies, with the overall objective being to lower an 
individual's usage in an attempt to address the issue of Social Media and Smartphone Addiction. To evaluate the project, a small group of participants were given the application to use over a 
three-week period, and were asked to send their usage data each week during this time. By the end of this period, they were also provided a survey where they could provide their own opinions 
on the app.\newline

Results from the evaluation show that the PRI was somewhat successful in reducing the usage of smartphones and social media in young adults by using concepts from Reality Therapy and usage 
...
I would like to thank everyone who I've met throughout my time at Glasgow Caledonian University. Whether that be a teacher, a friend, or someone helpful on campus, you have helped shape
...
discussed. It will also provide an overview on the project and its objectives to be achieved in the literature 
...
While SA isn't classified the same way other addictions such as drug addiction is classified, the nature of it is 
instead classified as a behavioural addiction \autocite{RefWorks:RefID:68-king2017impact}, and in a similar manner, 
SMA is considered to be a subset of Internet Addiction \autocite{RefWorks:RefID:66-hou2019social}, which itself is 
considered a subset of behavioural addiction \autocite{RefWorks:RefID:95-chou2005review}. While both are 
typically categorised as separate types of addiction, it has been argued by some that SA may be correlated with 
SMA, due to smartphones themselves being enablers for addictive behaviours, including SMA 
\autocite{RefWorks:RefID:73-kuss2017social}. \newline

Despite this, the use of the term "addiction" has received pushback, due to the sensationalist language the term brings \autocite{RefWorks:RefID:96-adorjan2021smartphone}, and also 
because both terms don't fit the typical perception of addiction with the term "Problematic Smartphone/Social Media Use" being used as an alternative 
term \autocite{RefWorks:RefID:97-rozgonjuk2018problematic}.\newline

\textcite{RefWorks:RefID:78-bhalerao2020analysis} analyse SA and provided potential causes 
...
looked to define a set of causes behind social media addiction and found that most individuals who considered themselves addicted to social media
were addicted due to factors such as a lack of friends outside of social media, the fact that social media was a "social activity requirement", a need to fulfil a task of some kind, ensuring 
that they were kept updated on current events, and the fact that social media was now ingrained with social life in a general sense.\newline

Another study from Turkish researchers \textcite{RefWorks:RefID:99-özcan2017smartphone} 
mentioned how alongside young people (defined as between 18-29) ranking first in internet usage, they're also more prone to problematic smartphone use, possibly due to the characteristics 
the phone carries that triggers heavy smartphone usage.
...
For mobile applications specifically, in 2013, a group of German researchers, 
...
\begin{minipage}{.5\textwidth}
	...
	\captionof{figure}{{Rules tab of AppDetox \autocite{RefWorks:RefID:74-löchtefeld2013appdetox}}}
	\label{fig:appdetox1A}
\end{minipage}%
\begin{minipage}{.5\textwidth}
	\centering
	\includegraphics[width=0.40\linewidth]{appdetox1B.png}
	\captionof{figure}{{Violations tab of AppDetox \autocite{RefWorks:RefID:74-löchtefeld2013appdetox}}}
	\label{fig:appdetox1B}
\end{minipage}
\end{figure}

The "AntiSocial" app, developed by Australian company BugBean, allowed users to restrict access to 
...
\noindent\underline{\textbf{Investigate existing mobile apps that use psychological methods}}\newline
\noindent\underline{\textbf{to address mental health issues}}\newline
...
\noindent\underline{\textbf{Investigate the contextualization of SA and SMA in existing apps}}\newline
...
\noindent\underline{\textbf{Investigate psychological frameworks}}\newline
...
\noindent\underline{\textbf{Investigate methods to track app usage}}\newline
...
\noindent\underline{\textbf{Gather participants for evaluating the app and perform evaluation}}\newline
...
\noindent\underline{\textbf{Analyse the results and obtain a conclusion}}\newline
...
This chapter presents an in-depth discussion of the results of the evaluation, including the findings themselves, reasoning on the 
...
This chapter concludes the report by summarizing the project in its entirety up to this point, before then presenting a final answer 
to the project's hypothesis. It then continues by providing critical analysis of the project and its limitations, and finally, discusses 
...
\textcite{RefWorks:RefID:35-dosselaar2017smartphone} says that developers lack a deep understanding of the topic, and points out the overall complexity of the issue, 
...
include a brief analysis on the research methodology used, and then an extensive look at the creation of the PRI, including commentary 
...
\centering
	...
	\captionof{figure}{{Typical iterative Waterfall methodology \autocite{RefWorks:RefID:161-trivedi2013comparative}}}
...
of these methodologies however, made for a methodology that was fitting for the project as a whole. Though this was an unforeseen risk according to the risk matrix and risk 
...
\centering
	...
	\captionof{figure}{{GitHub branches for each requirement}}
	\label{fig:gitbranch}
\end{figure}
...
can be found within Appendices D and E. \newline

\subsubsection{Psychological Intervention Method}

The psychological intervention method is a critical component for the PRI, as this would then be used to derive functional requirements of the application, therefore,
...
a person defines a goal and if their current action is stopping them from that goal. From there, they are encouraged to replace the activity with a better alternative. \newline
% could probably cut this section
...
Finding a method of tracking a user's smartphone and social media usage was a simpler endeavour. As mentioned in section 2.4, Apple's iOS operating system disallows apps from tracking a user's usage
...
\centering
	...
	\captionof{figure}{{UsageStatsManager class from android.app.usage, taken from Android's API documentation within Android Studio \autocite{androiddevelopment-usagestatsmanager}}}
	\label{fig:usagestatsmanager}
\end{figure}

The "android.app.usage" package contains many classes that provide detailed statistics about a user's device, but the class of interest for use within the PRI is the "UsageStatsManager" 
...
user interviews that were performed as well. All requirements were then compiled into a single document, the Software Requirements Specification document, which would frequently be referred to during
development.
...
\centering
	...
	\captionof{figure}{{Req-1.2 Flowchart Diagram}}
...
\centering
	...
	\captionof{figure}{{First iteration of requirement 1.3's flowchart design}}
...
\begin{figure}[H]
	...
	\captionof{figure}{{Final iteration of requirement 1.3's flowchart design}}
...
\centering
	...
	\captionof{figure}[]{{Req-1.5 / Req-1.7 Flowchart Diagram}}
...
only function if the app was at a specific point. Requirement 1.7's constraints note that: \newline
...
\centering
	...
	\captionof{figure}{{UI wireframe of the "Enable Notifications" screen during the onboarding process - Made for Requirement 1.5/1.7}}
...
\centering
	...
	\captionof{figure}{{UI wireframe of the "Activity Entry Screen" screen during the onboarding process - Made for Requirement 1.5/1.7}}
...
\centering
	...
	\captionof{figure}{{UI wireframe of the Main Screen}}
...
Code snippet \ref{lst:loadUsage} shows the function used to fetch the usage data for the user. This function is called on app start-up, as it gets called within the onCreate method. The function calls the
...
\centering
	...
	\captionof{figure}{{Folder structure of GitHub repo}}
...
Code snippet \ref{lst:periodicworkrequest} and \ref{lst:workerclass} shows the code and class used for sending notifications. Code snippet \ref{lst:periodicworkrequest} defines a PeriodicWorkRequest variable
...
snippets were for ensuring functionality, both would be refined over the course of development. Note that code snippet \ref{lst:periodicworkrequest} would later be changed to trigger every 7 days, and
...
\centering
	...
	\captionof{figure}{{Class structure of PRI at the prototyping stage}}
	\label{fig:class-structure}
\end{figure}

\subsubsection{Req-1.5 / 1.7}
...
\begin{lstlisting}[language=Java, style=mystyle, caption={Original implementation of writing the app list to a file}, label=lst:og-app-list-csv]
...
\centering
	...
	\captionof{figure}{{File attachment issue (email recipient has been hidden)}}
...
\autocite{java-fileoutputstream, java-filewriter}. This rewritten code, and the successful attachment is shown below in code snippet \ref{lst:new-app-list-csv} and figure \ref{fig:file-attach-after}.

\begin{lstlisting}[language=Java, style=mystyle, caption={New implementation of writing the app list to a .csv file}, label=lst:new-app-list-csv]
...
\centering
	...
	\captionof{figure}{{File attachment issue, now fixed (email recipient has been hidden)}}
...
figuring out a way to store a user's old usage time to compare, as the comparison would be used to send the user to correct set of screens.
...
\begin{lstlisting}[language=Java, style=mystyle, caption={Goal definition screen, rewritten for requirement 1.3}, label=lst:goal-definition-rewrite]
...
SharedPreference API, the random hard-coded activities are retrieved from a separate string array file called strings.xml (see Appendix K), then two pseudorandom numbers are selected, and 
...
This branch was used to add the graph used for displaying the usage for the previous week to the user. While a wireframe diagram for this
...
The data from the .csv file then needs to be parsed properly to display it to the user, and this was achieved by using the external library OpenCSV and the CSVReader class. The code shown below
...
the set of activities. A small snippet of the code used can be found below in code snippet \ref{lst:editing-activity}, but the full code block where this was performed can be found in Appendix M.
...
\centering
	...
	\captionof{figure}{{Results from PRI evaluation}}
...
\centering
	...
	\captionof{figure}{{Results from PRI evaluation, without the outlier data}}
...
slightly, though experiences an overall increase when compared from the baseline to week-3.

\begin{figure}[H]
\centering
	\includegraphics[width=1\linewidth]{eval-data-social-media-only.png}
	\captionof{figure}{{Results from PRI evaluation, only showing social media usage}}
...
While the graph is relatively the same, there are some differences. For example, unlike the total usage, 1A's social media usage never increases, rather, it takes a small decline 
...
opinions on using the app throughout the evaluation period, with the survey including a variety of multiple choice and open-ended questions. Two question
...
\centering
	...
	\captionof{figure}{{Results from question 3 from the post-evaluation survey}}
...
\centering
	...
	\captionof{figure}{{Results from question 11 from the post-evaluation survey}}
...
\textcite{RefWorks:RefID:35-dosselaar2017smartphone}, as it was discussed that existing intervention apps don't provide an opportunity for users to reflect and learn about SA and SMA. Not only this,
...
helped them achieve the goal they set out, and most participants said they would recommend the app in its current state to others (see Appendix O), with one participant stating the app is a 
...
Alongside this, any data taken from participants was ensured to be compliant under the Data Protection Act 2018. When ensuring the protection of 
...
away from their smartphone and social media and set goals for themselves that they can achieve away from their smartphone and social media. \newline
...
of this nature raises concerns regarding the autonomy, well-being of participants  \autocite{RefWorks:RefID:175-punchoojit2015research}, but 
this specific use of human participants brings forth another issue, that being the issue of data collection. The evaluation 
...
To conduct any part of the project where human participants are required, ethical approval was required prior to conducting any part of it.
All the details written about previously were mentioned within the ethics form, alongside reasonable 
...
attributed the app to be a significant factor in a reduction in their usage, and carry the opinion that the app helped them achieve their set goal. Therefore, this second point is proven to be true 
...
Although not an issue for the current iteration of the project, from September of 2026 onwards, apps to be installed on Android devices in certain regions will have to 
...
The project was also limited during the evaluation phase, due to the number of participants involved. While the intention was to gather ten participants for the evaluation, only 
...
\centering
	...
	\captionof{figure}[]{{Risk Register (originally from RS\&PI Project Planning report)}}
...
\centering
	...
	\captionof{figure}[]{{Risk Matrix (originally from RS\&PI Project Planning report)}}
...
\centering
	...
	\captionof{figure}[]{{Project Plan Gantt Chart (originally from RS\&PI Project Planning report)}}
...
\centering
	...
	\captionof{figure}[]{{Req-1.1 Flowchart Diagram}}
...
\centering
	...
	\captionof{figure}[]{{Old iteration of First iteration of requirement 1.3's flowchart design}}
...
\centering
	...
	\captionof{figure}[]{{New iteration of Req-1.3 Flowchart Diagram}}
...
\centering
	...
	\captionof{figure}[]{{Req-1.4 Flowchart Diagram}}
...
\centering
	...
	\captionof{figure}[]{{Req-1.6 Flowchart Diagram}}
...
\centering
	...
	\captionof{figure}[]{{Req-1.8 Flowchart Diagram}}
...
\centering
	...
	\captionof{figure}[]{{UI wireframe of the first onboarding screen}}
...
\centering
	...
	\captionof{figure}[]{{UI wireframe of the second onboarding screen}}
...
\centering
	...
	\captionof{figure}[]{{UI wireframe of the "Enable Usage Tracking" screen}}
...
\centering
	...
	\captionof{figure}[]{{UI wireframe of the "Goal Entry" screen}}
...
\centering
	\includegraphics[width=0.45\linewidth]{ui/Onboarding Activity Entry Screen.png}
	\captionof{figure}[]{{UI wireframe of the "Activity Entry" screen}}
...
\centering
	\includegraphics[width=0.45\linewidth]{ui/Onboarding Notification Screen.png}
	\captionof{figure}[]{{UI wireframe of the "Enable Notification" screen}}
...
\centering
	...
	\captionof{figure}[]{{UI wireframe of the settings screen}}
...
\centering
	...
	\captionof{figure}[]{{UI wireframe of the screen used to compliment a user on their usage}}
...
\centering
	...
	\captionof{figure}[]{{UI wireframe of the screen used to ask the user if they want to redefine their goal}}
...
\centering
	...
	\captionof{figure}[]{{UI wireframe of the screen used to ask the user to evaluate their usage}}
...
\centering
	...
	\captionof{figure}[]{{UI wireframe of the "Activity Suggestion" screen}}
...
\noindent https://github.com/AmjadIbraheem/UsageStats
...
As previously mentioned in section 4.2, the number of respondents matched the number of participants who took part in the evaluation, that being 4. Note that because the open-ended questions were 
optional, not all participants provided a response to them.\newline\newline
...
\centering
	...
	\captionof{figure}[]{{Question 1 from Question Set 1}}
	\label{fig:qs1-q1}
\end{figure}
...
\centering
	...
	\captionof{figure}[]{{Question 2 from Question Set 1}}
	\label{fig:qs1-q2}
\end{figure}
...
\centering
	...
	\captionof{figure}[]{{Question 3 from Question Set 1}}
	\label{fig:qs1-q3}
\end{figure}
...
\centering
	...
	\captionof{figure}[]{{Question 4 from Question Set 1}}
	\label{fig:qs1-q4}
\end{figure}
...
\centering
	...
	\captionof{figure}[]{{Question 1 from Question Set 2}}
	\label{fig:qs2-q1}
\end{figure}
...
\centering
	...
	\captionof{figure}[]{{Question 2 from Question Set 2}}
	\label{fig:qs2-q2}
\end{figure}
...
\centering
	...
	\captionof{figure}[]{{Question 3 from Question Set 2}}
	\label{fig:qs2-q3}
\end{figure}
...
\centering
	...
	\captionof{figure}[]{{Question 4 from Question Set 2}}
	\label{fig:qs2-q4}
\end{figure}
...
\centering
	...
	\captionof{figure}[]{{Question 5 from Question Set 2}}
	\label{fig:qs2-q5}
\end{figure}
