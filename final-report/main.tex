...
another function "showUsage" to show the usage to the user. \newline
...
\subsection*{Appendix I - screenCheck() function (branch req-1.5/1.7)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Appendix J - Activities string array from strings.xml}
\begin{lstlisting}[language=XML, style=mystyle, caption={XML code for storing the string array of activities}, label=lst:stringsXML]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Appendix K - Code used to show the previous weeks' usage}
...
\subsection*{Appendix L - Code used for updating a set of activities}
...
\subsection*{Appendix M - Test Case results}
...
\subsection*{Appendix N - Post-Evaluation survey results}
\underline{\textbf{QS1}}\newline\newline
