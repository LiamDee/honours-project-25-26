...
The type of diagram used for designing the application based on the requirements was a Flowchart diagram, a diagram which uses components that represent logic, order, and decision-points within a system
to model said system or related processes, making it easy for developers to understand event sequences or the overall structure of a system \autocite{RefWorks:RefID:166-ghritlahare2025role}. Flowchart 
diagrams were the exclusive diagram used for designing the application. This type of diagram was decided upon due to
...
https://github.com/LiamDee/honours-project-25-26/tree/main/documentation/interview-transcripts
...
\textit{Flowchart diagrams were created in an "unregistered" version of StarUML, which applies a watermark to any diagrams exported. This explains the large "UNREGISTERED" watermark
on each image.} \newline
...
\pagebreak
\noindent\textbf{Req-1.3}
\begin{figure}[H]
\centering
	\includegraphics[width=0.6\linewidth]{diagrams/req-1_3-diagram.jpg}
	\captionof{figure}[]{\textit{Req-1.3 Flowchart Diagram}}
...
\textit{Requirements 1.5 \& 1.7 were merged into a single diagram to reduce redundancy.}
\begin{figure}[H]
\centering
