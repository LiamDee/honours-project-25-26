...
user interviews that were performed as well. 
...
requirement identified in detail, similar in manner to Table \ref{tab:func-req-1-5-main}, alongside non-functional requirements can be found in Appendix X, as well as the Software Requirements 
Specification document separately via the GitHub repository.
