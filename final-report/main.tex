...
% 	\captionof{figure}{\textit{Iterative Waterfall methodology \autocite{RefWorks:RefID:161-trivedi2013comparative}}}
...
When evaluating if the PRI meets the hypothesis, objective, and research statement, a mixed-method approach was used. (define mixed-method approach)
...
Once they had set up the application, they were also asked to send their usage to use said usage stats as a baseline to compare the usage for the next three weeks.
...
recordings, etc...\autocite{RefWorks:RefID:164-bernard2016analyzing}. While the data from the previous section are an important piece
of the evaluation as a whole, getting this kind of data helps to understand thoughts and feelings from participants, and help in understanding
...
of this nature means that..(citation here with consequence)...but this use of human participants brings forth another issue. The evaluation involved collecting app usage data 
from participants, as well as responses from the post-evaluation survey. \newline
