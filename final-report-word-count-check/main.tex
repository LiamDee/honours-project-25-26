...
has been performed extensively in the past, with some 
...
applications that use some form of usage tracking to address the issue. Research has shown that psychological-based treatments has provided 
promising results in treating similar issues such as anxiety, and has even seen integration with mobile apps. Similarly, studies conducted show viability in
utilising usage tracking when addressing the issue,
...
Figure \ref{fig:gitbranch} showcases the process behind implementing and testing the PRI. A GitHub branch that matched the name of the requirement was 
...
The psychological intervention method is a critical componentfor the PRI, as this would then ben used to derive functional requirements of the application, therefore,
...
Finding a usage tracking method was a simple task. As mentioned in section 2.4, Apple's iOS operating system disallows apps from tracking a user's usage
